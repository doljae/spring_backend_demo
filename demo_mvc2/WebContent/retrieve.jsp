...
<body>
<div class="container">
    <form class="form-horizontal" action="retrieve.do?no=${notice.no}" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="noo" value="${notice.no}" readonly>
            </div>
            <label for="title" class="col-sm-2 control-label">조회수</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="readcnt" value="${notice.readcnt}" readonly>
            </div>
        </div>
        <div class="form-group">
